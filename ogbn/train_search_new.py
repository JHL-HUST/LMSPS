...
def main(args):
    ...
    for stage in range(args.start_stage, len(args.stages)):
        ...
        for epoch in range(epochs):
            ...
            if stage == 0:
                loss_w, loss_a, acc_w, acc_a  = train_search_new(model, train_loader, loss_fcn, optimizer_w, optimizer_a, val_loader, epoch_sampled, evaluator, device, feats, label_feats, labels_cuda, label_emb, scalar=scalar)
            else:
