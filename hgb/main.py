...
def main(args):
    ...
    if args.dataset != 'Freebase':
        ...
        if args.neighbor_attention:
            ...
            g = hg_propagate_feat_dgl(g, tgt_type, args.num_hops, max_length, echo=False)
            feats = {}
    ...
    for stage in [0]:
        ...
        if args.neighbor_attention:
            ...
            model = SeHGNN(args.embed_size, args.hidden, num_classes, feats.keys(), label_feats.keys(), tgt_type,
                args.dropout, args.input_drop, args.att_drop, args.label_drop,
                args.n_layers_1, args.n_layers_2, args.act, args.residual, bns=args.bns, data_size=data_size, num_heads=args.nh,
    ...
    return [round(test_acc[0]*100,2), round(test_acc[1]*100,2)]
