    ...
    for stage in [0]:
        ...
        if args.neighbor_attention:
            ...
            model = SeHGNN(args.embed_size, args.hidden, num_classes, feats.keys(), label_feats.keys(), tgt_type,
                args.dropout, args.input_drop, args.att_drop, args.label_drop,
                args.n_layers_1, args.n_layers_2, args.act, args.residual, bns=args.bns, data_size=data_size, num_heads=args.nh, path=archs[args.arch][0],
                label_path=archs[args.arch][1], remove_transformer=args.remove_transformer, independent_attn=args.independent_attn)
        ...
        for epoch in tqdm(range(args.stage)):
            ...
            #print(log)
            metrics = {"validation_loss": loss_val,
                       "test_micro": test_acc[0]*100,
                       "test_macro": test_acc[1]*100,
                       }
...
if __name__ == '__main__':
    ...
    # micro = micro/n
    # macro = macro/n
    # print( {f'micro: {micro:.2f}', f'macro: {micro:.2f}'})
    # metrics = {"micro": micro,
    #            "macro": macro}
